                ...
                <tr>
                    ...
                    <td class="text-center">
                        ...
                        if ($siswa['status_lulus'] == 0) {
                            echo anchor('Admin/lulus/' . $siswa['id'], '<div class="btn btn-sm btn-success"><i class="fas fa-check-circle"></i></div>');
                        } else {
                            echo anchor('Admin/tidaklulus/' . $siswa['id'], '<div class="btn btn-sm btn-danger"><i class="fas fa-times-circle"></i></div>');
                        }
                        ?>
                    </td>
                </tr>
