    ...
    <div class="row ml-3">
        ...
        <div class="col-md-5">
            ...
            <form class="user" method="POST" action="<?= base_url('Superintendent/tambahkapal'); ?>">
                ...
                <div class="form-group">
                    <input type="text" class="form-control form-control-user" id="trasportasi" name="trasportasi" placeholder="Trasportasi ke Sekolah" value="<?= set_value('trasportasi'); ?>">
                    <?= form_error('trasportasi', '<small class="text-danger pl-3">', '</small>'); ?>
                </div>
